...
name: Elementals
scc: mcdm.monsters.v1/monster.group/elementals
...
[Elementals](../../rule/keyword/elemental.md) change like the winds and the tides, and from age to age, they remake themselves to reflect what the world has become. They are protectors armored by stone, lizards ablaze with fire, and sometimes [dragons](dragons.md) clad in steel.

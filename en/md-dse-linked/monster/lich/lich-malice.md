---
features:
    - body: The lich makes a [free strike](scc:mcdm.heroes.v1/feature.common.main-actions/free-strike) against one enemy within 20 squares. They then gain an edge on their next power roll.
      cost: 3 Malice
      icon: "\U0001F464"
      name: Soul Sip
    - body: The lich takes an additional main action on their turn. They can use this feature even if they are [dazed](scc:mcdm.heroes.v1/condition/dazed).
      cost: 5 Malice
      icon: ☠️
      name: Solo Action
    - body: The lich summons a swirling cloud of angry spirits to surround them until the start of the next round. Any creature who deals damage to the lich with a melee strike while the spirit shell is active makes a **Presence test**.
      ...
      power_roll:
        tiers:
            high: No effect.
            low: 16 psychic damage, [dazed](scc:mcdm.heroes.v1/condition/dazed) (save ends)
            mid: '[Dazed](scc:mcdm.heroes.v1/condition/dazed) (save ends)'
    - body: |-
...
At the start of a lich's turn, you can spend [Malice](../../rule/monster/malice.md) to activate one of the following features.

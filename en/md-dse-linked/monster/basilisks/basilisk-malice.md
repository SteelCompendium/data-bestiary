...
features:
    ...
    - cost: 5 Malice
      ...
      power_roll:
        formula: + 2
        tiers:
            high: 4 damage; A < 2 5 damage, [prone](scc:mcdm.heroes.v1/condition/prone) and can't stand (save ends)
            low: 4 damage
            mid: 4 damage; A < 1 2 damage, [prone](scc:mcdm.heroes.v1/condition/prone)
      sections:
        - label: Effect
...
scc: mcdm.monsters.v1/monster.basilisks/basilisk-malice

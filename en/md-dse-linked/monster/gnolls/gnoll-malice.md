...
features:
    ...
    - icon: '|'
      ...
      power_roll:
        tiers:
            high: No effect.
            low: 6 damage; [bleeding](scc:mcdm.heroes.v1/condition/bleeding) (save ends)
            mid: 4 damage; [bleeding](scc:mcdm.heroes.v1/condition/bleeding) (EoT)
      sections:
        - label: Effect

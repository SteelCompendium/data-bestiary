...
This repo (the Draw Steel **Monsters** book data) has been consolidated into the single
**[`data-unified`](https://github.com/SteelCompendium/data-unified)** repo.

Find this book's content at:

- **Book-faithful:** `en/books/monsters/<format>/` (`md`, `json`, `yaml`, `md-linked`, `md-dse`, `md-dse-linked`)
